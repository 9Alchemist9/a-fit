// static/script.js - O SEU CÓDIGO, COM A TRAVA DE SEGURANÇA

// ADIÇÃO 1: Trava de segurança para garantir que este script rode apenas uma vez.
if (!window.formListenerAttached) {
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        const mascaraTelefone = {
            mask: [
                { mask: '+{55} (00) 0000-0000', lazy: false },
                { mask: '+{55} (00) 0 0000-0000', lazy: false }
            ]
        };
    ...
    // ADIÇÃO 2: Ativa a trava de segurança.
    window.formListenerAttached = true;
  }
